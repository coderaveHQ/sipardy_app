...
class SPColors {
  ...
  /// The color indigo 100
  static const Color indigo100 = Color(0xFFEBF4FF);
  /// The color indigo 200
  static const Color indigo200 = Color(0xFFC3DAFE);
  /// The color indigo 300
  static const Color indigo300 = Color(0xFFA3BFFA);
  /// The color indigo 400
  static const Color indigo400 = Color(0xFF7F9CF5);
  /// The color indigo 500
  static const Color indigo500 = Color(0xFF667EEA);
  /// The color indigo 600
  static const Color indigo600 = Color(0xFF5A67D8);
  /// The color indigo 700
  static const Color indigo700 = Color(0xFF4C51BF);
  /// The color indigo 800
  static const Color indigo800 = Color(0xFF434190);
  /// The color indigo 900
  static const Color indigo900 = Color(0xFF3C366B);

  /// The color purple 100
  static const Color purple100 = Color(0xFFF4F4FF);
  /// The color purple 200
  static const Color purple200 = Color(0xFFE2E1FF);
  /// The color purple 300
  static const Color purple300 = Color(0xFFCBCCFF);
  /// The color purple 400
  static const Color purple400 = Color(0xFFABABFF);
  /// The color purple 500
  static const Color purple500 = Color(0xFF8D8DFF);
  /// The color purple 600
  static const Color purple600 = Color(0xFF5D5DFF);
  /// The color purple 700
  static const Color purple700 = Color(0xFF4B4ACF);
  /// The color purple 800
  static const Color purple800 = Color(0xFF38379C);
  /// The color purple 900
  static const Color purple900 = Color(0xFF262668);
  ...
  static const Color primaryBackground = Color(0xFF22263B);
  /// The secondary background color
  static const Color secondaryBackground = Color(0xFF292F47);
  /// The tertiary background color
  static const Color tertiaryBackground = Color(0xFF2C324B);
  /// The primary button background color
  static const Color primaryButtonBackground = Color(0xFF8872F7);
}